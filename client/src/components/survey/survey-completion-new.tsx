...
export default function SurveyCompletionNew({ surveyData, sections }: SurveyCompletionProps) {
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="flex flex-col space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-8">Survey Complete!</h1>
            
            <div className="mb-8">
              <h3 className="text-lg font-medium text-gray-600">Your AI Readiness Score:</h3>
              <p className="text-6xl font-bold text-blue-600 mt-2">{overallScore}%</p>
            </div>
            
            <h3 className="text-xl font-semibold text-gray-700 mb-4">Readiness Breakdown:</h3>
          ...
          {/* Report error (mobile only) */}
          <Alert variant="destructive" className="border-red-200 bg-red-50 md:hidden">
            <AlertDescription>
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-6">Detailed Analysis & Recommendations:</h2>
          
          {/* Report error (desktop only) */}
          <Alert variant="destructive" className="border-red-200 bg-red-50 mb-6 hidden md:block">
            <AlertDescription>
              There was an error generating your report. Please try again later.
            </AlertDescription>
          </Alert>
                  ...
                  <AccordionItem value={`item-${index}`} className="border-0">
                    <AccordionTrigger className="px-4 py-3 hover:bg-gray-50 [&>svg]:text-blue-500">
                      <div className="flex justify-between items-center w-full pr-4">
                        ...
                        <Badge className="ml-2 whitespace-nowrap" variant={getBadgeVariant(category.level)}>
