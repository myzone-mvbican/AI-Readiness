          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Not sure how to answer? Contact our AI readiness experts for
          ...
          {isCreatingNewSurvey ? (
            ...
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Complete the quarterly assessment to evaluate your AI
                  readiness. This typically takes 10-15 minutes.
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-4">
                <div className="rounded-md border p-6 text-center">
                  ...
                  <h3 className="mt-4 text-lg font-medium">
                    Create Q2 2025 Assessment
                  </h3>
                  <p className="mt-2 text-sm text-gray-600">
                    Evaluate your organization's AI readiness for the current
                    quarter
                  </p>
                  <Button
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-sm">
                    <li className="flex gap-2">
                      ...
                      <span>
                        Track your organization's AI maturity over time
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0" />
                      <span>
                        Identify opportunities for improvement in your AI
                        strategy
                      </span>
                    </li>
                    <li className="flex gap-2">
