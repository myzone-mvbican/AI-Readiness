          ...
          <div className="md:col-span-3">
            <Card className="shadow-sm">
              <CardContent className="p-6">
                <div className="space-y-6">
                  <div>
                    <h3 className="text-base font-medium mb-3">Google Account</h3>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          {user?.googleId ? (
                            <div>
                              <div className="text-sm font-medium text-gray-900">Google account connected</div>
                              <div className="text-xs text-gray-500">You can use Google to sign in to your account</div>
                            </div>
                          ) : (
                            <div>
                              <div className="text-sm font-medium text-gray-900">Connect Google account</div>
                              <div className="text-xs text-gray-500">Link your Google account for easier sign-in</div>
                            </div>
                          )}
                        </div>
                      </div>
