  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      const descriptions: Record<string, string> = {
        ...
        '/assessment': 'Complete your AI readiness assessment to understand your organization\'s current capabilities and improvement opportunities.',
        '/dashboard': 'View your AI readiness dashboard with assessments, benchmarks, and performance insights.',
        '/dashboard/compare': 'Compare your AI readiness scores against industry and global benchmarks.',
        '/dashboard/assessments': 'Manage and review your completed AI readiness assessments and detailed reports.',
        '/dashboard/surveys': 'Create and manage custom AI readiness surveys for your organization.',
        '/auth': 'Sign in to access your AI readiness assessment dashboard and manage your organization\'s progress.'
      };
