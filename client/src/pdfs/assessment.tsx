...
export const AssessmentPDF = ({
  ...
  const logoPath = logoUrl || "@/assets/logo-myzone-ai.png";
    ...
    <Document>
      ...
      <Page size="A4" style={styles.coverPage}>
        ...
        <Text style={styles.coverFooter}>
          Generated by Keeran Networks AI · AI Readiness Framework
        </Text>
      </Page>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          <Text style={styles.pageNumber}>© {year} Keeran Networks AI</Text>
          ...
          return (
            <Page key="recommendations-static" size="A4" style={styles.page}>
              ...
              >
                ...
                organization's specific needs, please contact the Keeran
                Networks AI team for a comprehensive consultation.
              </Text>
